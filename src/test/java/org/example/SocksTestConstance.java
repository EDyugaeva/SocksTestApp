...
public class SocksTestConstance {
    ...
    public static final Socks SOCK_1 = new Socks(COlOUR_RED, QUANTITY_50, COTTON_PART_80);
    public static final Socks SOCK_2 = new Socks(COlOUR_RED, QUANTITY_MINUS_70, COTTON_PART_80);
